...
/**
 * <p>Classe responsavel pelas operacoes entre a Classe de Entidade <b>Usuario</b> e a Persitencia.</p>
 * @author  Rafael
 * @version 1.0
 * @since   30/10/2015
 * @see     modelo.dao.Dao
...
public class DaoUsuario extends Dao<Usuario> {
     ...
     * <p>Define a Classe de Entidade Usuario como Entidade da superclasse Dao.</p>
     */
    public DaoUsuario() {
        super(Usuario.class);
    }
    ...
    /**
     * Metodo responsavel por retornar uma Matriz com os elementos principais dos Usuarios.
