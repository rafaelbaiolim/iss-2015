...
/**
 * Classe responsavel por definir a Interface de Consulta do Sistema.
 * @author  Rafael
 * @version 1.0
 * @since   21/10/2015
 */
public abstract class ViewConsulta extends ViewModal implements InterfaceView {
     ...
     */
    public ViewConsulta(View oViewParent) {
        super(oViewParent);
        this.setSettings();
    }
    ...
    protected void addHeader(String sUrlImage) {
        this.addLinhas(1);
        this.jLabelHeader = new JLabel(new FunctFrame().createImage("consulta/" + sUrlImage));
    ...
    public void addButtons() {
        ...
        this.jButtonAction2 = this.createButton("Remover", "exit.jpg");
